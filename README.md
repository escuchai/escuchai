...
- [Episodio #10 - Especial sobre Inteligencia Artificial en el Cine](#episodio-10---especial-sobre-inteligencia-artificial-en-el-cine)
...
- [Machine Bias](www.propublica.org/article/machine…inal-sentencing)
- Librería [LIME](https://github.com/marcotcr/lime) 
- Librería [SHAP](https://github.com/slundberg/shap)
- Librería [Aequitas](https://aequitas.dssg.io)
- Archivo de publicaciones de [FATML](www.fatml.org/resources/relevant-scholarship)
...
- [Ethically Aligned Design principles](https://standards.ieee.org/content/dam/iee…ther/ead_v2.pdf)
- [Extension of Asimov’s laws para resolver el problema del trolley](https://papers.ssrn.com/sol3/papers.cfm?a…stract_id=3110582)
- [Probabilistic robotics, Thurn et al.](https://mitpress.mit.edu/books/probabilistic-robotics)
- [RAD Lab](https:// rad.inf.ed.ac.uk/)
- [Atlas parkour video](www.youtube.com/watch?v=_sBBaNYex3E)
...
- [El blog técnico de Netflix](https://medium.com/netflix-techblog)
- [El blog técnico de AI Google](https://ai.googleblog.com)
- [Open AI gym](https://gym.openai.com/) para Reinforcement Learning
- Baselines implementación de los [algoritmos más usados](https://github.com/openai/baselines) en RL.
- [Hipótesis del ticket de lotería](https://openreview.net/forum?id=rJl-b3RcF7)
